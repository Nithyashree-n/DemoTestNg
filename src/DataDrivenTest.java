...
// Selenium-TestNG Suite cleanup
  ...
  ((Object) driver.manage()).window().maximize();
    ...
    public void flightDeals(String SourcePattern, String Source, String DestPattern, String Destination,
            String departdate, String returndate, String adults, String children, String infants, String ticketClass)
...
driver.findElement(By.id("intlDeptCode")).click();
        ...
        for (WebElement option : optionsToSelect) {
            if (option.getText().contains(Source)) {
        ...
        driver.findElement(By.id("intlArrvCode")).sendKeys(DestPattern);
        driver.findElement(By.id("intlArrvCode")).click();
        ...
        for (WebElement cell : column) {
            ...
            if (cell.getText().equals(temp1[0])) {
                ((WebDriver) cell).findElement(By.linkText(temp1[0])).click();
                break;
            }
        }
        ...
        driver.findElement(By.id("addAnFlt")).click();
        ...
        AssertJUnit.assertTrue(iFlightOption > 0, "No flight option found!");
    }
    ...
    public void waitForPageLoaded() {
        ...
        for (; elapsedSeconds < maxWait;) {
            try {
                ...
                WebElement findElement = driver.findElement(By.cssSelector("p.ng-binding"));LangSel
